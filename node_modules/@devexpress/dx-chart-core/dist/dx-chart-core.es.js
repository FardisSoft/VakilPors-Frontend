...
var mergeContinuousDomains = function (domain, items) {
    var newDomain = extent(__spreadArray(__spreadArray([], __read(domain), false), __read(items), false));
...
var getPiePointTransformer = function (_a) {
    ...
    var pieData = pie().sort(null).value(function (d) { return d.value; })(points);
...
/** @internal */
var dPie = function (maxRadius, innerRadius, outerRadius, startAngle, endAngle) { return arc()({
