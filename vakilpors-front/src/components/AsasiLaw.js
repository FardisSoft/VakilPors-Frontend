  ...
  return (
    ...
    <Grid container sx={{padding: "50px 0",display:"flex",justifyContent:"center",alignItems:"center"}}> 
      <Grid container width={{xs:'95%',sm:'90%',md:'80%'}} direction={'column'}>
        ...
        <Typography variant="h1" sx={{fontSize:40,fontFamily: "shabnam",color:"darkblue"}}>قانون اساسی</Typography> 
        </Grid>
        <Typography variant="body1" sx={{marginTop: "10px",fontFamily: "shabnam"}}>

        <Grid sx={{ display:"flex",justifyContent:"center",alignItems:"center"}}>
            <Typography variant="h4" sx={{fontSize:20,fontFamily: "shabnam", marginTop: "20px",color:'blue'}}>فصل اول - اصول کلی</Typography>
        </Grid>
            اصل اول <br/>
        ...
        <Grid sx={{ display:"flex",justifyContent:"center",alignItems:"center"}}>
            <Typography variant="h4" sx={{fontSize:20,fontFamily: "shabnam", marginTop: "20px",color:'blue'}}>فصل دوم - زبان، خط، تاریخ و پرچم کشور</Typography>
        </Grid>
        ...
        <Grid sx={{ display:"flex",justifyContent:"center",alignItems:"center"}}>
            <Typography variant="h4" sx={{fontSize:20,fontFamily: "shabnam", marginTop: "20px",color:'blue'}}>فصل سوم - حقوق ملت</Typography>
        </Grid>
        ...
        <Grid sx={{ display:"flex",justifyContent:"center",alignItems:"center"}}>
            <Typography variant="h4" sx={{fontSize:20,fontFamily: "shabnam", marginTop: "20px",color:'blue'}}>فصل چهارم - اقتصاد و امور مالی</Typography>
        </Grid>
        ...
        <Grid sx={{ display:"flex",justifyContent:"center",alignItems:"center"}}>
            <Typography variant="h4" sx={{fontSize:20,fontFamily: "shabnam", marginTop: "20px",color:'blue'}}>فصل پنجم - حق حاکمیت ملت و قوای ناشی از آن</Typography>
        </Grid>
        ...
        <Grid sx={{ display:"flex",justifyContent:"center",alignItems:"center"}}>
            <Typography variant="h4" sx={{fontSize:20,fontFamily: "shabnam", marginTop: "20px",color:'blue'}}>فصل ششم - قوه مقننه</Typography>
        </Grid>
            ...
            اصل نود و پنجم
            <br/>
            در مواردی كه شورای نگبهان مدت ده روز را برای رسیدگی و اظهار نظر نهایی كافی نداند، می‏تواند از مجلس شورای اسلامی حداكثر برای ده روز دیگر با ذكر دلیل خواستار تمدید وقت شود.
            <br/><br/>
            اصل نود و ششم
            <br/>
        ...
        <Grid sx={{ display:"flex",justifyContent:"center",alignItems:"center"}}>
            <Typography variant="h4" sx={{fontSize:20,fontFamily: "shabnam", marginTop: "20px",color:'blue'}}>فصل هفتم - شوراها</Typography>
        </Grid>
        ...
        <Grid sx={{ display:"flex",justifyContent:"center",alignItems:"center"}}>
            <Typography variant="h4" sx={{fontSize:20,fontFamily: "shabnam", marginTop: "20px",color:'blue'}}>فصل هشتم - رهبر یا شورای رهبری</Typography>
        </Grid>
        ...
        <Grid sx={{ display:"flex",justifyContent:"center",alignItems:"center"}}>
            <Typography variant="h4" sx={{fontSize:20,fontFamily: "shabnam", marginTop: "20px",color:'blue'}}>فصل نهم - قوه مجریه</Typography>
        </Grid>
        ...
        <Grid sx={{ display:"flex",justifyContent:"center",alignItems:"center"}}>
            <Typography variant="h4" sx={{fontSize:20,fontFamily: "shabnam", marginTop: "20px",color:'blue'}}>فصل دهم - سیاست خارجی</Typography>
        </Grid>
        ...
        <Grid sx={{ display:"flex",justifyContent:"center",alignItems:"center"}}>
            <Typography variant="h4" sx={{fontSize:20,fontFamily: "shabnam", marginTop: "20px",color:'blue'}}>فصل یازدهم - قوه قضائیه</Typography>
        </Grid>
        ...
        <Grid sx={{ display:"flex",justifyContent:"center",alignItems:"center"}}>
            <Typography variant="h4" sx={{fontSize:20,fontFamily: "shabnam", marginTop: "20px",color:'blue'}}>فصل دوازدهم - صدا و سیما</Typography>
        </Grid>
        ...
        <Grid sx={{ display:"flex",justifyContent:"center",alignItems:"center"}}>
            <Typography variant="h4" sx={{fontSize:20,fontFamily: "shabnam", marginTop: "20px",color:'blue'}}>فصل سیزدهم - شورای عالی امنیت ملی</Typography>
        </Grid>
        ...
        <Grid sx={{ display:"flex",justifyContent:"center",alignItems:"center"}}>
            <Typography variant="h4" sx={{fontSize:20,fontFamily: "shabnam", marginTop: "20px",color:'blue'}}>فصل چهاردهم - بازنگری در قانون اساسی</Typography>
        </Grid>
