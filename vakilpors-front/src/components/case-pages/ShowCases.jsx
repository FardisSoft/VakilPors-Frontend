...
//         <CardContent>
//           <Typography
//             sx={{ fontFamily: "shabnam", fontSize: 14 }}
...
//             item
//             xs={12}
//             sx={{ overflow: "hidden", width: "200px", cursor: "pointer" }}
...
//               borderRadius={"10px"}
//               paddingY={"50px"}
//               paddingX={{ xs: "0px", sm: "10px", md: "50px" }}
//               display={"flex"}
//               m={"2%"}
    ...
    return (
      <React.Fragment>
        <CardContent sx={{ borderRadius: "5px 5px 5px 5px" }}>
          ...
          {isLawyer !== "false" && (
            <Box style={{marginTop:'10px'}} backgroundColor={"lightblue"} borderRadius={2}>
              <IconButton size="small">
                <a
                  href={casei.fileUrl == "null" ? null : casei.fileUrl}
                  download={"download"}
        ...
        {isLawyer === "false" && (
          <div style={{marginTop:'-6px',marginBottom:'10px',marginRight:'15px'}}>
            <Button
              onClick={() => navigate(`/new-case/edit_${casei.id}`)}
