          ...
          <div class="box-shadow teacher-box-size">
            ...
            <Link to={`/LawyerPage/${Lawyer.id}`}>
              <h2 className="align-center">
                <p class="my-1">
                  <BsFillPersonFill color="black" size={"20px"} /> نام و نام
                  خانوادگی :{" "}
                </p>
                <a title={Lawyer.user.name}>
                  <i class="zmdi zmdi-account mx-3"></i> {Lawyer.user.name}{" "}
                  {Lawyer.isVerified && (
                    <StyledTooltip
                      title={
                        <React.Fragment>
              ...
              <h2>
                <p class="my-1">
                  <BsPersonWorkspace color="black" size={"20px"} /> عنوان :{" "}
                </p>
                <a title={Lawyer.title}>
                  <i class="zmdi zmdi-account mx-3"></i>{" "}
              ...
              <h2>
                <p class="my-2">
                  <GiRank3 color="black" size={"20px"} /> میانگین امتیاز :{" "}
                </p>
