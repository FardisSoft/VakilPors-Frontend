            ...
            <div className="form-v4-content2">
              ...
              <form className="form-detail" id="myform">
                ...
                <div className="form-group">
                  <div className="form-row form-row-1">
                    <label style={{ position: "relative", top: "5px" }}>
                      <p>عکس پس زمینه پروفایل</p>
                    </label>
                    <MuiFileInput
                      fullWidth
                      margin="10px"
                      value={refdetail.current.profileBackgroundPicture}
                      inputProps={{ style: { padding: "20px 10px" } }}
                ...
                <div className="form-group">
                  <div className="form-row form-row-1">
                    ...
                    <MuiFileInput
                      fullWidth
                      margin="10px"
                      value={refdetail.current.callingCardImage}
                      inputProps={{ style: { padding: "20px 10px" } }}
                  ...
                  <div className="form-row form-row-1">
                    ...
                    <MuiFileInput
                      fullWidth
                      margin="10px"
                      value={refdetail.current.resume}
                      inputProps={{ style: { padding: "20px 10px" } }}
                ...
                <div className="form-group">
                  <div className="form-row">
                    <label style={{ position: "relative", top: "5px" }}>
                      <p>
                        کارت ملی (کارت ملی شما در پروفایل شما نمایش داده نخواهد
                        شد و تنها جهت احراز هویت شما توسط ادمین مورد بررسی قرار
                        می گیرد)
                      </p>
                    </label>
                    <MuiFileInput
                      fullWidth
                      margin="10px"
                      value={refdetail.current.nationalCardImage}
                      inputProps={{ style: { padding: "20px 10px" } }}
