...
const LawyerPage = () => {
  ...
  const handleChatStart = async () => {
    ...
    if (!token) {
      ...
      const url =
        BASE_API_ROUTE + `Chat/StartChat?recieverUserId=${lawyerUserId}`;
      try {
          ...
          <Stack spacing={5} maxWidth="100%" margin={2}>
            ...
            >
              <Grid
                sx={{
                  backgroundImage: `url(${
                    profileBackgroundPicture ? profileBackgroundPicture : dlpbp
                  })`,
              ...
              >
                <CardContent>
                  ...
                  <Rating
                    ...
                    readOnly
                  />
                  <Typography sx={{ fontSize: "12px", fontFamily: "shabnam" }}>
                    {" "}
                    میانگین امتیاز {rate} بر اساس {numberOfRates} نظر{" "}
                  </Typography>
                </CardContent>
              </Grid>
              <Grid
            ...
            >
              <Grid item component={Card} sm>
                <CardContent>
                  {isVerified && (
                    <Typography
                      sx={{ mb: 1.5, fontFamily: "shabnam" }}
                      color="text.secondary"
                    >
                      <Verified
                        color="primary"
                        sx={{ mr: 1, position: "relative", top: 3 }}
                      />
                ...
                <CardContent>
                  ...
                  >
                    <Percent
                      ...
                      sx={{ mr: 1, position: "relative", top: 3 }}
                    />
                    درصد پاسخ های تایید شده :{" "}
                    {numberOfAnswers != 0
                      ? (numberOfVerifies / numberOfAnswers).toFixed(2) * 100
                      : 0}{" "}
                    %
                  </Typography>
                </CardContent>
            ...
            >
              ...
              >
                ...
                />
                <CardMedia
                  image={`https://api.qrserver.com/v1/create-qr-code/?data=${window.location}&size=200x200`}
                  sx={{ alignSelf: "center", height: 180, width: 180, mb: 2 }}
                  title="QR کد وکیل"
                />
              </Grid>
              <Grid item component={Card} sm>
                ...
                <CardContent>
                  <Typography
                    sx={{ mb: 1.5, fontFamily: "shabnam", fontSize: "15px" }}
                    color="text.secondary"
                  >
                    {aboutMe}
                  </Typography>
              ...
              >
                ...
                <CardMedia
                  ...
                  sx={{ alignSelf: "center", height: 167, width: 300 }}
                  title="کارت ویزیت"
                />
                <CardContent>
                  <Grid container direction="row">
                    ...
                    <Typography
                      sx={{ ml: 4, fontFamily: "shabnam", fontWeight: "bold" }}
                      color="text.secondary"
                    >
